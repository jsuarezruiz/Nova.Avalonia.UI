...
- **[CodeViewer](xref:Nova.Avalonia.UI.CodeViewer.CodeViewer)**: Show read-only source code with syntax highlighting, line numbers, and copy support from an optional package.
