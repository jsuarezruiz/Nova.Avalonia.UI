...
- **[CircularSlider](docs/controls/circularslider.md)**: Circular arc slider for selecting numeric values with customizable angles, step frequencies, and center content.
- **[FortuneBar](docs/controls/fortune.md)**: Slot machine style horizontal or vertical scrolling bar for random selection.
- **[FortuneWheel](docs/controls/fortune.md)**: Circular prize wheel with smooth spin animations, weighted selection, and customizable styling strategies.
