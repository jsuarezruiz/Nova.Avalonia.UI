...
- **[CompareSlider](xref:Nova.Avalonia.UI.Controls.CompareSlider)**: A control that allows side-by-side comparison of two pieces of content with a draggable divider.
